...
# loading data
cnn_data <- read.csv(file = "./data/PSICOV_box_12/output/cnn_wt_max_freq.csv", header=TRUE, sep=",")
natural_data <- read.csv(file = "./data/PSICOV_box_12/output/natural_max_freq_files/natural_max_freq_all.csv", header=TRUE, sep=",")
...
plot_12_a <- joined_single_and_class %>%
  ...
  ggtitle(label = "12A Box: Predicting Wild Type") +
  theme_cowplot(12) + 
